# The entirity of this code is not mine, but this is a good starting point
# to build your own bounding box processor. Have fun :)
# This file is for testing purposes, it allows you to work with tesseract
# related bounding boxes, and apply filtering/preprocessing on them,
# such as non-maximum surpression.
# Related to tesseract / pytesseract sdk
